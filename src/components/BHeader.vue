...
<template>
  ...
  <div class="container-fluid px-3">
    <header class="main-nav d-flex justify-content-center py-3">
      <ul class="nav nav-pills flex-nowrap justify-content-center">
        ...
        <li class="nav-item">
          <router-link to="/BookShop" class="nav-link" active-class="active">
            Book Shop
          </router-link>
        </li>
        <li class="nav-item">
        ...
        <li v-if="!isAuthenticated" class="nav-item">
          <router-link to="/login" class="nav-link" active-class="active">Local Login</router-link>
        </li>
